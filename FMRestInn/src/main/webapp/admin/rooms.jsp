...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  ArrayList<Room> rooms = (ArrayList)request.getAttribute("roomList"); %>
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>  
	...
	<div class="container">
	<h4 class="text-center my-5 fs-2">Choose our best rooms for your preference</h4>
			    ...
			    <img src="<%= room.getImage() %>" class="card-img-top" alt="<%= room.getTitle() %> image">
			  	<div class="card-body">
				    ...
				    <p class="card-text">
			          ...
			          <a href="edit?room_id=<%= room.getId() %>" id="btn_edit" class="btn btn-primary">Edit</a>
			          <a href="delete?room_id=<%= room.getId() %>" id="btn_delete" class="btn btn-primary">Delete</a>
			  	 </div>
				</div>		
		</div>
	<% } %>	
